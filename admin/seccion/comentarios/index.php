...
$sentencia = $conexion->prepare("SELECT * FROM `tbl_comentarios`");  //consulta
$sentencia->execute();                                         // y muestra
$lista_comentarios = $sentencia->fetchAll(PDO::FETCH_ASSOC);        //los registros
...
<br />
<div class="card">
    <div class="card-header">Bandeja de Contacto</div>
    <div class="card-body">
